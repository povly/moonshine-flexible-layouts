...
- **Дублирование блоков** — свежий серверный рендер того же типа + копирование значений полей; лимиты проверяются на сервере
...
- **Тесты:** unit-тесты PHPUnit (`vendor/bin/phpunit`) — домен Block/BlockCollection/FlexibleCast; UI проверяется вручную в хост-приложении
